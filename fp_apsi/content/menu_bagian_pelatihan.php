			...
			<div class="row py-5 justify-content-center">
				<div class="col-sm-3">
					<div class="text-center">
						<a href="bagian_pelatihan/form_pengisian_jadwal_pelatihan.php"><img class="card-img-top" src="logo/calendar.png" alt="Card image cap" style="width: 128px; height: 128px;"></a>						
					</div>
				...
				<div class="col-sm-3">
					<div class="text-center">
						<a href="bagian_pelatihan/materi_pelatihan_upload.php"><img class="card-img-top" src="logo/folder.png" alt="Card image cap" style="width: 128px; height: 128px;"></a>	
					</div>
