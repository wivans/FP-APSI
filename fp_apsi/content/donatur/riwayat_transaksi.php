...
<body>
        ...
        <div class="container">
            ...
            <h4 class="text-center py-3">RIWAYAT TRANSAKSI DONASI</h4>
                ...
                <div class="col-sm-8 mx-5 text-center">
                    <table class="table table-hover font-weight-bold">
                        <thead>
                            ...
                            <th scope="col">Tanggal & Waktu Transaksi</th>
                            ...
                            <div class="row justify-content-end">
                                <div class="col-sm-3">
                                    <div class="text-center">
                                        <a href="../menu_donatur.php"><img src="../logo/window-back-button.png" alt="Card image cap" style="width: 32px; height: 32px;"></a>  
                                    </div>
