<!DOCTYPE HTML>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="registrasi_donatur.css">
	</head>
	<body>
		...
		<div class="container pb-5">
			<nav class="nav nav-pills nav-justified justify-content-center">
  				<a class="nav-link active" href="#Pengajar">Pengajar</a>
			  	<a class="nav-link" href="#Donatur">Donatur</a>
			</nav>	
		</div>
		...
		<div id="Donatur">
			<div class="container">
				...
				<h4 class="text-center py-3">FORM REGISTRASI DONATUR</h2>
