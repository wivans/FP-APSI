<!DOCTYPE HTML>
	...
	<body>
		...
		<div class="container">
			...
			<h4 class="text-center pt-3 pb-4">MENU BAGIAN PENEMPATAN</h4>
			
			<div class="row py-5 justify-content-center">
				<div class="col-sm-3">
					<div class="text-center">
						<a href="bagian_penugasan/form_pengisian_kelompok_pengajar.php"><img class="card-img-top" src="logo/group.png" alt="Card image cap" style="width: 128px; height: 128px;"></a>
				...
				<div class="col-sm-3">
					<div class="text-center">
						<a href="bagian_penugasan/form_pengisian_tempat_penugasan.php"><img class="card-img-top" src="logo/planet-earth.png" alt="Card image cap" style="width: 128px; height: 128px;"></a>
